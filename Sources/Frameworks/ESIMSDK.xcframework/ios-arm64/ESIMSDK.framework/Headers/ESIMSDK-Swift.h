...
#ifndef ESIMSDK_SWIFT_H
#define ESIMSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ESIMSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7ESIMSDK19DeepLinkCoordinator")
@interface DeepLinkCoordinator : NSObject
...
SWIFT_CLASS("_TtC7ESIMSDK20PhoneNumberFormatter")
...
@interface PhoneNumberFormatter (SWIFT_EXTENSION(ESIMSDK))
